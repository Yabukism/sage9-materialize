...
class SearchPostContent extends Search {
	function find( $pattern, $limit, $offset, $orderby ) {
		...
		$sql = "SELECT ID, post_content, post_title FROM {$wpdb->posts} WHERE post_status != 'inherit' AND post_type IN ('post','page','my_keywords','world-history','japanese-history') ORDER BY ID ".$orderby;
