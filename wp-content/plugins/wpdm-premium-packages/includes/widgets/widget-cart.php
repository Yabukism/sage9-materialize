...
class WPDMPP_MiniCart extends WP_Widget {
    ...
    function __construct() {
        global $pagenow;
        parent::__construct( /* Base ID */'WPDMPP_MiniCart', /* Name */'Cart', array( 'description' => 'Premium Packages Mini Cart Widget' ) );
    ...
    function load_ajax_cart(){
        ...
        <div class='media'>
            ...
            <span id='wpdmpp_mini_cart_subtotal'>" . $currency_sign . wpmpp_get_cart_total() . "</span> &nbsp; | &nbsp; " . __("Checkout", "wpdm-premium-packages") . "</button>
        </div>
        <script language='JavaScript'>
            function  wpdmpp_mpp_remove_cart_item(id){
                   if(!confirm('".__('Are you sure?','wpdm-premium-packages')."')) return false;
