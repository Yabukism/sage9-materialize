    ...
    foreach ($order_notes['messages'] as $time => $order_note) {
        ...
        <div class="panel panel-default dashboard-panel">
            <div class="panel-body">
                <?php $note = wpautop(strip_tags(stripcslashes($order_note['note']),"<a><strong><b><img>")); echo preg_replace('/[\s]+((http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?)/', '<a target="_blank" href="\1">\1</a>', $note); ?>
    ...
    <div class="panel panel-default dashboard-panel">
        ...
        <div id="plupload-upload-ui" class="panel-footer attachments drag-drop-area">
            <div id="filelist" class="pull-right"></div>
              <button id="plupload-browse-button" type="button" class="btn btn-default btn-xs" ><i class="fa fa-file"></i> &nbsp; <?php esc_attr_e('Attach Files','wpdm-premium-packages'); ?></button>
