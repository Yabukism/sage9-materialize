...
<div class="w3eden">
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            <b><i class="fa fa-ticket color-purple"></i> &nbsp;
            ...
            <div class="pull-right">
                <a href="edit.php?post_type=wpdmpro&page=pp-coupon-codes" class="btn btn-sm btn-default">
                    <i class="fa fa-long-arrow-left color-green"></i> <?php _e('Back','wpdm-premium-packages'); ?>
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form method="post" action="" id="add-license-form">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Never" id="expdate" type="text" name="coupon[expire_date]" value="<?php echo isset($coupon)  ? date("Y-m-d H:i a", $coupon->expire_date):''; ?>" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary"><i class="fa fa-floppy-o"></i> &nbsp;<?php _e('Save Coupon Code','wpdm-premium-packages'); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
