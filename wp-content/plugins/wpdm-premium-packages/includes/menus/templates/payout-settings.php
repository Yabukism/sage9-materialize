        ...
        <div class="panel-heading"><?php _e("Commissions","wpdm-premium-packages");?></div>
         ...
         <table class="table table-striped">
             ...
             <tr>
                 ...
                 <td><input  class="form-control input-sm" style="width: 80px" type="text" size="8" name="comission[default]" value="<?php echo $comission['guest']; ?>"></td>
             </tr>
             <?php
             global $wp_roles;
            ...
            foreach( $roles as $role => $name ) {
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control input-sm" style="width: 80px" size="8" name="comission[<?php echo $role; ?>]" value="<?php echo $comission[$role]; ?>"></td>
                </tr>
            <?php } ?>
            <tr>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="" method="post">
            ...
            <input class="form-control input-sm" style="width: 80px;display: inline" type="text" name="payout_duration" value="<?php echo $payout_duration;?>" >  <?php _e("Days","wpdm-premium-packages");?>
