...
<div class="w3eden">
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            <b><i class="fa fa-id-card-o color-purple"></i> &nbsp; <?php _e('New License', 'wpdm-premium-packages'); ?></b>
        </div>
        <div class="panel-body"><br/><br/><br/>
                ...
                <form method="post" action="" id="add-license-form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" class="form-control input-lg" type="text"  name="license[licenseno]" readonly="readonly" value="<?php echo LicenseManager::generate_licensekey(); ?>">
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4"><div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn"><button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal"><i class="fa fa-search-plus"></i></button></div>
                                </div>
                            </div></div>
                        <div class="col-md-4"><div class="form-group">

                                <label><?php _e('Status:','wpdm-premium-packages'); ?></label>
                                <select name="license[status]" class="form-control">
                                    <option value="1"><?php _e('Online','wpdm-premium-packages'); ?></option>
                                    <option value="0"><?php _e('Offline','wpdm-premium-packages'); ?></option>
                                </select>
                            </div></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary"><i class="fa fa-floppy-o"></i> Add New License</button>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <div class="input-group">
                           ...
                           <div class="input-group-btn"><button type="button" class="btn btn-default" id="srcpnow"><i class="fa fa-search"></i></button></div>
                       </div>
                        <br/>
