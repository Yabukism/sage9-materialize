<?php
/**
 * Order details Template for [wpdm-pp-purchases] shortcode
 *
 * This template can be overridden by copying it to yourtheme/download-manager/partials/user-order-details.php.
 *
 * @version     1.0.0
 */
    ...
    <div class="panel panel-default panel-purchases">
        <div class="panel-heading">
            <?php if ( $order->order_status == 'Completed' ) { ?>
                ...
                <a href="<?php echo $link; ?>" style="display:inline;with:auto;"><?php _e("Purchases","wpdm-premium-packages"); ?></a> &nbsp;<i class="fa fa-angle-double-right"></i>&nbsp;<?php echo $order->title; ?>
            <?php } else { ?>
