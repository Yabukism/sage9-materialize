            ...
            <table class="wpdm_cart table">
                ...
                foreach ( $cart_data as $ID => $item ) {
                    ...
                    <tr id='cart_item_<?php echo $ID; ?>'>
                        ...
                        <td class='cart_item_remove hidden-xs'>
                            <a class='wpdmpp_cart_delete_item btn btn-xs btn-danger' href='#' onclick='return wpdmpp_pp_remove_cart_item(<?php echo $ID; ?>)'><i class='fa fa-trash-o'></i></a>
                        </td>
                        ...
                        <td class='cart_item_subtotal amt'>
                            ...
                            <?php echo $currency_sign_before . $item_total . $currency_sign_after; ?>
                        </td>
                ...
                <tr id="cart-total">
                    ...
                    <td class="amt">
                        ...
                        <strong id="wpdmpp_cart_subtotal"><?php echo $currency_sign_before . $cart_subtotal . $currency_sign_after; ?></strong>
                    </td>
                </tr>
                <!-- Cart Sub Total end  -->
                ...
                <tr id="cart-total-with-tax">
                    ...
                    <td class="amt">
                        ...
                        <strong id="wpdmpp_cart_grand_total"><?php echo $currency_sign_before . $cart_total_with_tax . $currency_sign_after; ?></strong>
                    </td>
                </tr>
