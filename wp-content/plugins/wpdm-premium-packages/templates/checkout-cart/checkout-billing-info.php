...
?>
<div class="panel-heading"><?php echo __("Billing Address", "wpdm-premium-packages"); ?></div>
<div class="panel-body">
    <!-- full-name input-->
    <div class="form-group">
        <label class="control-label"><?php echo __("Full Name", "wpdm-premium-packages"); ?> <span class="required" title="<?php _e('Required', 'wpdm-premium-packages'); ?>">*</span></label>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="controls">
                    ...
                    ?>
                    <select id="country" name="billing[country]" required="required" class="form-control <?php echo wpdmpp_tax_active() ? 'calculate-tax' : ''; ?>" data-live-search="true" x-moz-errormessage="<?php echo __("Please Select Your Country", "wpdm-premium-packages"); ?>">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label><?php echo __("Phone", "wpdm-premium-packages"); ?> <span class="required" title="<?php _e('Required', 'wpdm-premium-packages'); ?>">*</span></label>
                <input type="tel" value="<?php echo $billing['phone']; ?>" required="required" class="form-control" name="billing[phone]" id="phone_m" placeholder="<?php echo __("Valid Phone Number", "wpdm-premium-packages"); ?>">
            </div>
            <div class="col-md-6">
