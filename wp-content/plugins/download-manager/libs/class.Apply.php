    ...
    function register()
    {
        ...
        if (!$user_id) {
            ...
            if (!$user_id) {
                ...
                if(isset($_SESSION['guest_order'])) unset($_SESSION['guest_order']);
                if(isset($_SESSION['login_error'])) unset($_SESSION['login_error']);
                if(isset($_SESSION['tmp_reg_info'])) unset($_SESSION['tmp_reg_info']);
                //if(!isset($_SESSION['reg_warning']))
                $creds['user_login'] = $user_login;
                $creds['user_password'] = $user_pass;
                $creds['remember'] = true;
                $_SESSION['sccs_msg'] = __( "Your account has been created successfully and login info sent to your mail address." , "download-manager" );
                if($auto_login==1) {
                    $_SESSION['sccs_msg'] = __( "Your account has been created successfully" , "download-manager" );
                    wp_signon($creds);
                ...
                $_SESSION['reg_error'] = __( "Email already exists." , "download-manager" );
            ...
            $_SESSION['reg_error'] = __( "User already exists." , "download-manager" );
            $plink = $_POST['permalink'] ? $_POST['permalink'] : $_SERVER['HTTP_REFERER'];
