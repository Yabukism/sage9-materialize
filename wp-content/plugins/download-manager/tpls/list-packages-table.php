...
<div class="input-group input-group-lg input-group-x"><input placeholder="<?php _e( "Search..." , "download-manager" ); ?>" type="text" id="sfld" class="form-control" name="q" value="<?php echo $Q; ?>"><div class="input-group-btn"><button class="btn btn-lg"><i class="fas fa-search color-green"></i></button></div></div>
    ...
    <th style="width: 140px" class="manage-column column-media text-center" id="media" scope="col" align="center"><?php _e( "Actions" , "download-manager" ); ?></th>
    </tr>
    </thead>
    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-<?php the_ID(); ?>">
                ...
                <td class="media column-media">
                    <a title="Edit" href="<?php echo sprintf($edit_url, get_the_ID()); ?>"><strong><?php the_title();?></strong></a>
                    <div class="text-muted">
                        <small><i class="far fa-copy"></i> <?php echo $tf = count(get_post_meta(get_the_ID(), '__wpdm_files', true)); ?> file<?php echo $tf > 1?'s':''; ?> </small>&nbsp;
