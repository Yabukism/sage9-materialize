            ...
            <div class="row">
                ...
                <!-- div class="col-md-12">
                    <div class="text-center panel panel-default" style="margin: 20px 0 0 0">
                        <div class="panel-heading">OR Connect Using Your Social Account</div>
                        <div class="panel-body">
                            <button type="button" onclick="return _PopupCenter('<?php echo home_url('/?connect=facebook'); ?>', 'Facebook', 400,400);" class="btn btn-social wpdm-facebook wpdm-facebook-connect"><i class="fab fa-facebook-f"></i></button>
                            <button type="button" onclick="return _PopupCenter('<?php echo home_url('/?connect=twitter'); ?>', 'Twitter', 400,400);" class="btn btn-social wpdm-twitter wpdm-linkedin-connect"><i class="fab fa-twitter"></i></button>
                            <button type="button" onclick="return _PopupCenter('<?php echo home_url('/?connect=linkedin'); ?>', 'LinkedIn', 400,400);" class="btn btn-social wpdm-linkedin wpdm-twitter-connect"><i class="fab fa-linkedin-in"></i></button>
                            <button type="button" onclick="return _PopupCenter('<?php echo home_url('/?connect=google'); ?>', 'Google', 400,400);" class="btn btn-social wpdm-google-plus wpdm-google-connect"><i class="fab fa-google"></i></button>
                        </div>
                    </div>
                </div -->
                <?php if($regurl != ''){ ?>
                <div class="col-md-12"><br/><a href="<?php echo $regurl; ?>" name="wp-submit" id="loginform-submit" class="btn btn-block btn-link btn-xs"><?php _e( "Don't have an account yet?" , "download-manager" ); ?> <i class="fas fa-user-plus"></i> <?php _e( "Register Now" , "download-manager" ); ?></a></div>
                <?php } ?>
            </div>
