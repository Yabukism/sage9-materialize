...
<?php } ?>
    ...
    <div class="row">
        <div class="col-md-<?php echo ($loginurl != '')?7:12; ?>"><button type="submit" class="btn btn-success btn-lg btn-block" id="registerform-submit" name="wp-submit"><i class="fas fa-user-plus"></i> &nbsp;<?php _e( "Join Now!" , "download-manager" ); ?></button></div>
        <?php if($loginurl != ''){ ?>
        <div class="col-md-5"><a href="<?php echo $loginurl;?>" class="btn btn-default btn-lg btn-block" id="registerform-login" name="wp-submit"><i class="fa fa-lock"></i> &nbsp;<?php _e( "Login" , "download-manager" ); ?></a></div>
        <?php } ?>
    </div>
