...
<div class="wrap w3eden">
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            ...
            <a style="margin-left: 10px" id="basic" href="edit.php?post_type=wpdmpro&page=wpdm-subscribers&task=export<?php echo (wpdm_query_var('lockOption') != ''?'&lockOption='.wpdm_query_var('lockOption'):''); ?>" class="btn btn-sm btn-default pull-right"><i class="fa fa-table color-green"></i> <?php echo __( "Export All" , "download-manager" ); ?></a>
            <a id="basic" href="edit.php?post_type=wpdmpro&page=wpdm-subscribers&task=export&uniq=1<?php echo (wpdm_query_var('lockOption') != ''?'&lockOption='.wpdm_query_var('lockOption'):''); ?>" class="btn btn-sm btn-default pull-right"><i class="fa fa-bars color-purple"></i> <?php echo __( "Export Unique Emails" , "download-manager" ); ?></a>&nbsp;
        </div>
