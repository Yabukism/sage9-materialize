...
*/ ?>
 ...
 <div class="panel panel-default">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- div class="form-group">
                            <label><?php echo __( "Category Access Blocked Message:" , "download-manager" ); ?></label>
                            <textarea class="form-control" cols="70" rows="6" name="__wpdm_category_access_blocked"><?php echo stripcslashes(get_option('__wpdm_category_access_blocked',__( "You are not allowed to access this category!" , "download-manager" ))); ?></textarea><br>
 ...
 <div class="panel panel-default">
     ...
     <div class="panel-body">
         ...
         <div class="form-group">
             <label><input type="checkbox" <?php checked(get_option('__wpdm_ind_stats'),1); ?> style="margin: 0" name="__wpdm_ind_stats" value="1"> <?php _e( "Increase download count on individual file download" , "download-manager" ); ?></label><br/>
         ...
         <div class="form-group"><input type="hidden" name="__wpdm_individual_file_download" value="0">
             <label><input type="radio" <?php checked(get_option('__wpdm_individual_file_download', 1),1); ?> style="margin: 0" name="__wpdm_individual_file_download" value="1">  <?php _e( "Enable Single File Download" , "download-manager" ); ?> &nbsp; </label>
             <label><input type="radio" <?php checked(get_option('__wpdm_individual_file_download', 1),0); ?> style="margin: 0" name="__wpdm_individual_file_download" value="0">  <?php _e( "Disable Single File Download" , "download-manager" ); ?></label><br/>
         ...
         <div class="form-group"><input type="hidden" name="__wpdm_cache_zip" value="0">
             <label><input type="checkbox" <?php checked(get_option('__wpdm_cache_zip'),1); ?> style="margin: 0" name="__wpdm_cache_zip" value="1">  <?php _e( "Cache created zip file from multi-file package" , "download-manager" ); ?></label><br/>
         ...
         <div class="form-group"><hr/>
             ...
             <label><input style="margin: 0 10px 0 0" type="checkbox" <?php checked(get_option('__wpdm_open_in_browser'),1); ?> value="1" name="__wpdm_open_in_browser"><?php _e( "Open in Browser" , "download-manager" ); ?></label><br/>
 ...
 <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            <legend><?php _e( "Styles & Scripts" , "download-manager" ); ?></legend>
                            <label style="margin-right: 20px"><input <?php checked('', get_option('__wpdm_bsversion','')); ?> type="radio" value="" name="__wpdm_bsversion"> <?php _e( "Bootstrap 3" , "download-manager" ); ?></label> <label><input  <?php checked('4', get_option('__wpdm_bsversion','')); ?>  type="radio" value="4" name="__wpdm_bsversion"> <?php _e( "Bootstrap 4" , "download-manager" ); ?></label>
                            <em class="note"><br/>All templates are not converted yet for Bootstrap 4, it will be done within May 30, 2018</em>
                            <hr/>
                            <ul>
