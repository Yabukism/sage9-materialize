...
<div class="panel panel-default">
    <div class="panel-heading"><b><?php _e( "Google API Credentials" , "download-manager" ); ?></b></div>
...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo __( "Twitter App Settings" , "download-manager" ); ?></div>
    <div class="panel-body">
    <div class="form-group">
