...
<div class="panel panel-default">
    ...
    <div class="panel-body">
            ...
            <button type="button" id="clearCache" style="width: 250px" class="btn btn-success btn-lg"><?php _e( "Empty Cache Dir" , "download-manager" ); ?></button>
            <button type="button" id="clearStats" style="width: 250px" class="btn btn-danger btn-lg"><?php _e( "Delete All Stats Data" , "download-manager" ); ?></button>
