<div class="panel panel-default">
    <div class="panel-heading">
        <div class="pull-right" style="margin-top: -3px"><a class="btn btn-xs btn-default" href="edit.php?post_type=wpdmpro&page=settings&tab=plugin-update&newpurchase=1"><i class="color-green fa fa-sync"></i> <?php _e( "Check For Updates" , "download-manager" ); ?></a>   <a class="btn btn-default btn-xs color-red" href="edit.php?post_type=wpdmpro&page=settings&tab=plugin-update&logout=1"><?php _e( "Logout" , "download-manager" ); ?></a></div>
        <i class="fa fa-sync"></i> &nbsp; <?php _e( "Add-on Update" , "download-manager" ) ?></div>
    <div class="panel-body-x">

        <?php if(get_option('__wpdm_suname') =='') { ?>
            <div class="panel-body">
                <div class="well log-req" style="width: 350px;margin: 30px auto;box-shadow: 0 0 15px rgba(0,0,0,0.1);padding: 30px 30px 15px;border-radius: 10px;background: rgba(0,0,0,0.02) !important;">
                <div class="form-group text-center">
                    ...
                    <div class="form-group text-center" style="font-weight: 300;text-transform: capitalize;font-size: 9pt;">
                        <?php echo sprintf(__( "Enter your %s login info" , "download-manager" ), '<a href="https://www.wpdownloadmanager.com/" target="_blank">WPDownloadManager.com</a>'); ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="well text-center" style="background: #ffffff;padding: 10px;box-shadow:none;color: #999;font-family: Montserrat, serif;font-weight: 300;font-size:10px;letter-spacing:0.6px;">
