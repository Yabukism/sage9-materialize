...
<div class="wrap w3eden">
    ...
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            <a class="btn btn-default btn-sm pull-right" href="edit.php?post_type=wpdmpro&page=wpdm-stats&task=export" style="font-weight: 400"><i class="sinc far fa-arrow-alt-circle-down color-green"></i> <?php _e("Export History",'download-manager'); ?></a>
            <b><i class="fa fa-bar-chart-o color-purple"></i> &nbsp; <?php echo __( "Download Statistics" , "download-manager" ); ?></b>
