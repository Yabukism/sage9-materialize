...
<a href="edit.php?post_type=wpdmpro&page=templates&_type=page&task=NewTemplate" class="btn btn-sm btn-default"><i class="fa fa-file color-purple"></i> <?php echo __( "Create Page Template" , "download-manager" ); ?></a> <a href="edit.php?post_type=wpdmpro&page=templates&_type=link&task=NewTemplate" class="btn btn-sm btn-default"><i class="fa fa-link color-green"></i> <?php echo __( "Create Link Template" , "download-manager" ); ?></a>
    </div>
    ...
    <form method="post" id="emlstform">
        <div class="panel panel-default">
            ...
            <div class="panel-footer text-right">
                <button class="btn btn-primary" id="emsbtn" style="width: 150px;"><i class="fas fa-hdd"></i> <?php _e( "Save Changes" , "download-manager" ); ?></button>
            </div>
        </div>
    </form>
    <?php } ?>
