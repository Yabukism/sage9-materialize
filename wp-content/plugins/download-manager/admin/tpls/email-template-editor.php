     ...
     <div class="panel panel-default" id="wpdm-wrapper-panel">
         <div class="panel-heading">
             ...
             <div class="pull-right">
                 <a href="edit.php?post_type=wpdmpro&page=templates&_type=page&task=NewTemplate" class="btn btn-sm btn-default <?php echo wpdm_query_var('_type')=='page'?'active':''; ?>"><i class="fa fa-file color-green"></i> <?php echo __( "Create Page Template" , "download-manager" ); ?></a> <a href="edit.php?post_type=wpdmpro&page=templates&_type=link&task=NewTemplate" class="btn btn-sm btn-default <?php echo wpdm_query_var('_type')=='link'?'active':''; ?>"><i class="fa fa-link color-purple"></i> <?php echo __( "Create Link Template" , "download-manager" ); ?></a>
             </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                <div class="input-group-addon" title="<?php echo __( "To Email" , "download-manager" ); ?>"><i class="fa fa-paper-plane-o"></i></div>
                                <input placeholder="<?php echo __( "To Email" , "download-manager" ); ?>" type="text" class="form-control input-lg" name="email_template[to_email]" value="<?php echo $tpl['to_email']; ?>">
                            </div>
