     ...
     <div class="panel panel-default" id="wpdm-wrapper-panel">
         <div class="panel-heading">
             ...
             <div class="pull-right">
                 <a href="edit.php?post_type=wpdmpro&page=templates&_type=page&task=NewTemplate" class="btn btn-sm btn-default <?php echo wpdm_query_var('_type')=='page'?'active':''; ?>"><i class="fa fa-file color-purple"></i> <?php echo __( "Create Page Template" , "download-manager" ); ?></a> <a href="edit.php?post_type=wpdmpro&page=templates&_type=link&task=NewTemplate" class="btn btn-sm btn-default <?php echo wpdm_query_var('_type')=='link'?'active':''; ?>"><i class="fa fa-link color-green"></i> <?php echo __( "Create Link Template" , "download-manager" ); ?></a>
             </div>
...
<form action="" method="post">
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo wpdm_query_var('task','txt')=='NewTemplate'?'New':'Edit'; ?> <?php echo $_GET['_type']=='page'?__( "Page" , "download-manager" ):__( "Link" , "download-manager" ); ?> <?php echo __( "Template" , "download-manager" ); ?></div>
...
?> 
    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-8">
                ...
                <?php echo __( "Title" , "download-manager" ); ?>:<br>
              ...
              <?php //the_editor(stripslashes($tpl['content']),'tpl[content]','content', true, true); ?>                
                ...
                <input type="submit" value="<?php echo __( "Save Template" , "download-manager" ); ?>" class="btn btn-primary">
