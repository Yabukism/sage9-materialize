...
<div style="clear: both;"></div>
 ...
 <div class="panel panel-default" id="wpdm-wrapper-panel">
     <div class="panel-heading"><button type="submit" class="btn btn-default pull-right"><i class="sinc far fa-hdd color-green"></i> &nbsp<?php _e( "Save Settings" , "download-manager" ); ?></button><h3 class="h"><i class="fa fa-cog color-purple" id="wdms_loading"></i>&nbsp;&nbsp;<?php _e( "Download Manager Settings" , "download-manager" ); ?></h3>
     </div>
...
<div class="alert alert-success" style="max-width: 300px !important;display: none;position: fixed; right: 15px;top: 100px;background: #ffffff !important;cursor: pointer" id="wpdm_message"></div>
...
<br>
         ...
         <button type="submit" style="width:200px" class="btn btn-info btn-lg"><i class="sinc far fa-hdd"></i> &nbsp;<?php _e( "Save Settings" , "download-manager" ); ?></button>
    ...
    jQuery('#wdm_settings_form').submit(function(){
       ...
       jQuery(this).ajaxSubmit({
        ...
        success: function(responseText, statusText, xhr, $form){
          jQuery('#wpdm_message').html("<p>"+responseText+"</p>").fadeIn();
          //setTimeout("jQuery('#wpdm_message').slideUp()",4000);
