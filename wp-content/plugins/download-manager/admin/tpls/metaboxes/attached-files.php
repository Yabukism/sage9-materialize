                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        ...
                                                        <input readonly="readonly" class="form-control" type="text" value="<?php echo $id; ?>">
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-default" onclick="__showDownloadLink(<?php the_ID(); ?>, <?php echo $id; ?>)"><i class="fa fa-link"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery('body').on('click','button[rel=del], button[rel=undo]', function () {
                            ...
                            if (jQuery(this).attr('rel') == 'del') {
                                ...
                                jQuery(this).attr('rel', 'undo').html('<i class="fa fa-sync text-danger"></i>');
