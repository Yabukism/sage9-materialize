...
<ul class="nav nav-tabs" style="padding-top:10px;padding-left: 10px;background: #fafafa">
    <li class="active"><a href="#upload" role="tab" data-toggle="tab"><?php echo __( "Upload" , "download-manager" ); ?></a></li>
    <?php  if(current_user_can('access_server_browser')){ ?>
    <li><a href="#browse" role="tab" data-toggle="tab"><?php echo __( "Browse" , "download-manager" ); ?></a></li>
    <?php } ?>
    <li><a href="#remote" role="tab" data-toggle="tab"><?php echo __( "URL" , "download-manager" ); ?></a></li>
</ul>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($){
            ...
            uploader.bind('FileUploaded', function(up, file, response) {
                ...
                html = html.replace(/##filetitle##/g, response);
                            ...
                            <div class="media-body">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        ...
                                        <input readonly="readonly" class="form-control" type="text" value="##fileindex##">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                <div class="input-group">
