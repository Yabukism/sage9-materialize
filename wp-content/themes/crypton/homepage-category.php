...
<?php $tcid =(int)wpeden_get_theme_opts('home_cat_4',1); $homecategory = get_category($tcid); $category_link = get_category_link( $homecategory->term_id ); //$introcontent = strip_tags($intropage->post_content,"p,br"); if (preg_match('/^.{1,100}\b/s', $introcontent, $match)) $introcontent = $match[0];  ?>
<div class="row">
...
<li class="col-md-3 home-cat-single"> 
