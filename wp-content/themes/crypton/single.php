...
<div class="breadcrumb post-meta">Posted on <?php the_date(); ?> / Posted by <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a>
<nav id="nav-single"> 
...
<h1 class="entry-title"><?php the_title(); ?></h1>
    ...
    <?php } else if(get_post_type()!='wpmarketplace') {  centrino_post_thumb(array(1100,0)); } ?>
