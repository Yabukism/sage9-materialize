                        ...
                        <?php foreach ($posts as $post) { ?>
                            <div class="item <?php echo $first++ == 1 ? 'active' : ''; ?>" id="slide-<?php echo $first; ?>">
                                ...
                                <div class="carousel-caption">
                                    <span class="lead slide-cat inv"  data-animation="animated zoomIn"><?php echo get_post_meta($post->ID, '__wpdm_download_count', true); ?> Downloads</span>
                                    ...
                                    <div class="intro" data-animation="animated fadeInUp">
                                        <span  data-duration="0.3s" data-delay="3s"><i class="tn-server"></i> <?php echo get_post_meta($post->ID, '__wpdm_package_size'); ?></span>
                                        <span  data-duration="0.3s" data-delay="3.3s"><i class="tn-server"></i> <?php echo get_post_meta($post->ID, '__wpdm_package_size'); ?></span>
                                        <span  data-duration="0.3s" data-delay="3.6s"></span>
                                    </div>
                                    <div class="meta">
                                        <a href="<?php echo get_permalink($post->ID);?>" class="btn btn-primary inv slide-btn"  data-animation="animated fadeInUp" data-delay="4s" data-duration="2s"><i class="tn-download"></i> <?php _e('Download Now','the-next');?></a>
                                    </div>
