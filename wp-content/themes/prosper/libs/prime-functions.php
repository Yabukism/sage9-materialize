...
class TheNextChild{
    ...
    function Actions(){
	    ...
	    add_action( 'wp_ajax_nopriv_contact_us', array($this, 'ContactRequest'));
	    add_action( 'wp_ajax_contact_us', array($this, 'ContactRequest'));
    ...
    function CustomHomepageSettingsSection($thenext_sections){
        $thenext_sections['thenext_new_products'] = array(
            'title' => __('New Products', 'the-next'),
            'description' => '',
        ...
        $thenext_sections['thenext_featured_pages'] = array(
            'title' => __('Featured Pages', 'the-next'),
            'description' => '',
            'panel' => 'thenext_o_homepage_options',
            'priority' => 119,
        );

        $thenext_sections['thenext_popupar_products'] = array(
            'title' => __('Popuplar Products', 'the-next'),
            'description' => '',
            'panel' => 'thenext_o_homepage_options',
            'priority' => 120,
        );
        ...
        $thenext_sections['thenext_home_c2a'] = array(
    ...
    function CustomHomepageSettingsFields($thenext_options){
        ...
        $thenext_options['thenext_new_products_hide'] = array(
            'label' => __('Hide New Products Section', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'checkbox',
            'section' => 'thenext_new_products',
            'std' => 1
        );
        $thenext_options['thenext_new_products_section_heading'] = array(
            'label' => __('New Products Section Heading', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_new_products',
        ...
        $thenext_options['thenext_new_products_category'] = array(
            'label' => __('Product Category', 'the-next'),
            'transport' => 'postMessage',
        ...
        $thenext_options['thenext_new_products_url'] = array(
            'label' => __('All Products', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'dropdown-pages',
            'section' => 'thenext_new_products',
            'default' => 0,
        ...
        $thenext_options['thenext_featured_pages_hide'] = array(
            'label' => __('Hide Featured Pages Section', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'checkbox',
            'section' => 'thenext_featured_pages',
            'std' => 1
        );
        $thenext_options['thenext_featured_pages_section_heading'] = array(
            'label' => __('Featured Pages Section Heading', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_featured_pages',
        ...
        $thenext_options['thenext_featured_pages_section_intro'] = array(
            'label' => __('Featured Pages Section Intro', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_featured_pages',
            'default' => 'Featured Pages Section Intro Goes Here'
        );



        $thenext_options['thenext_popupar_products_hide'] = array(
            'label' => __('Hide Popupar Products Section', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'checkbox',
            'section' => 'thenext_popupar_products',
            'std' => 1
        );
        $thenext_options['thenext_popupar_products_section_heading'] = array(
            'label' => __('Popupar Products Section Heading', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_popupar_products',
            'default' => 'Popupar Products'
        );

        $thenext_options['thenext_popupar_products_category'] = array(
            'label' => __('Product Category', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'dropdown-taxonomy',
            'section' => 'thenext_popupar_products',
        ...
        $thenext_options['thenext_popupar_products_url'] = array(
            'label' => __('All Popupar Products', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'dropdown-pages',
            'section' => 'thenext_popupar_products',
            'default' => 0,
        ...
        $thenext_options['thenext_c2a_text'] = array(
            'label' => __('Call To Action Text', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_home_c2a',
            'default' => 'Ask your visitor to do something'
        );

        $thenext_options['thenext_c2a_link'] = array(
            'label' => __('Call To Action Button Link', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_home_c2a',
            'default' => '#'
        ...
        $thenext_options['thenext_c2a_link_label'] = array(
            'label' => __('Call To Action Button Label', 'the-next'),
            'transport' => 'postMessage',
            'type' => 'text',
            'section' => 'thenext_home_c2a',
    ...
    function ContactRequest(){
        if(isset($_POST['contact'])){
            ...
            $message = "Name: {$_POST['contact']['name']}<br/>Email: {$_POST['contact']['email']}<br/>Message:<br/>{$_POST['contact']['message']}";
            $params = array('subject' => "Contact Request From: {$_POST['contact']['name']} ( {$user_email} )", 'to_email' => get_option('admin_email'), 'message' => $message);
    ...
    function TemplateTags($vars){
        ...
        $purl = get_post_meta($vars['ID'], '__wpdm_acf_LivePreview_sitepreview', true);
        $vars['live_preview'] = $purl?"<div class='widget panel'><div class=\"panel-body\"><a  target=_blank href='".$purl."' class='btn btn-block btn-inverse btn-lg no-radius'>Live Preview</a></div></div>":'';
