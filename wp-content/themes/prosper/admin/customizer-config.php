...
$thenext_sections = array(
    ...
    */
    ...
    'thenext_header_bg_options' => array(
        'title' => __('Header', 'the-next'),
        'description' => '',
...
$thenext_options = array(
    'header_bg' => array(
        'label' => __('Header Background', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'image',
        'section' => 'thenext_header_bg_options',
        'default' => '',
    ),
    'site_logo' => array(
    ...
    'main_navdd_bg' => array(
        'label' => __('DropDown Background', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'color',
        'section' => 'thenext_color_options',
        'default' => '',
    ),
    'main_navdd_color' => array(
        'label' => __('DropDown Text Color', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'color',
        'section' => 'thenext_color_options',
        'default' => '',
    ...
    'menuh_color' => array(
        'label' => __('DropDown Hover Background', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'color',
        'section' => 'thenext_color_options',
        'default' => '',
    ...
    'heading_font_size' => array(
        'label' => __('H1 Font Size', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'range',
        'section' => 'thenext_generic_fonts',
        'default' => '25',
    ...
    'heading2_font_size' => array(
        'label' => __('H2 Font Size', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'range',
        'section' => 'thenext_generic_fonts',
        'default' => '20',
    ...
    'heading3_font_size' => array(
        'label' => __('H3 Font Size', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'range',
        'section' => 'thenext_generic_fonts',
        'default' => '15',
    ...
    'heading4_font_size' => array(
        'label' => __('H4 Font Size', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'range',
        'section' => 'thenext_generic_fonts',
        'default' => '13',
