...
<div class="navbar navbar-default navbar-static-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse header-collapse">
            ...
            <p class="navbar-text navbar-right">Mindshare Labs</p>
...
<div class="container">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default" id="content-formatting">
                ...
                <div class="panel-body">
                    ...
                    <hr>
                    <blockquote>Here's what a blockquote looks like in Bootstrap.
            ...
            <form>
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail">Email address</label> <input type="text" class="form-control" id="exampleInputEmail" placeholder="Enter email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword">Password</label> <input type="password" class="form-control" id="exampleInputPassword" placeholder="Password">
                    </div>
                    <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="panel panel-default" id="images">
                ...
                <div class="panel-body">
                    <p><img src="http://placehold.it/100x100" class="img-rounded"> <img src="http://placehold.it/100x100" class="img-circle"> <img src="http://placehold.it/100x100" class="img-thumbnail"></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-9">
            <div class="panel panel-default" id="input-groups">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <div class="input-group">
                        <input type="text" class="form-control input-large"> <span class="input-group-addon input-large">.00</span>
                    </div>
                    <br>
                    <div class="input-group">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="list-group">
                <a href="#" class="list-group-item active"><h4 class="list-group-item-heading">List group item heading</h4>          <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                </a><a href="#" class="list-group-item"><h4 class="list-group-item-heading">List group item heading</h4>          <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p></a><a href="#" class="list-group-item">
                    <h4 class="list-group-item-heading">List group item heading</h4>          <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p></a>
            </div>
        </div>
    </div>
    <div class="row">
